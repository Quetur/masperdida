// Pegá esto al principio de tu signin.js
function aplicarDeteccion(inputVisible, inputHidden) {
  ...
  visible.on("input", function () {
    ...
    // Lógica simple: si contiene @ es email, sino lo tratamos como celular
    if (valor.includes("@")) {
      oculto.val(valor); // Es un email
    } else {
      // Limpiamos caracteres no numéricos para el celular
